...
namespace Teleporter.UI
{
    ...
    public sealed class TeleporterWindow : ProgrammaticWindowBase
    {
        ...
        public override Window.Sizing   Sizing => Window.Sizing.Resizable(new Vector2Int(400, 250));

        private List<LocationGroup> Groups => Main.Instance?.Settings.Groups ?? [];
        ...
        // TODO: convert to metadata builder
        ...
        private void BuildGroup(UIPanelBuilder builder, string groupName) {
            ...
            if (_NewLocationGroup != groupName) {
                ...
                Messenger.Default.Send(new SettingsChangedEvent());
                return;
            }
            ...
            static Action TeleportTo(TeleportLocation location) {
                return () => {
